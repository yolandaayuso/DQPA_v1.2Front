...
export declare class PolarSplineSeries extends PolarLineSeriesBase {
    ...
    acu: PolarSplineSeriesView;
    constructor();
    acv: number;
    protected q9(a: any, b: string, c: any, d: any): void;
    protected acs(a: SeriesView): void;
    act(a: PolarFrame, b: PolarBaseView): void;
    static $$p: string[];
}
/**
 * @hidden
...
export declare class PolarSplineSeriesView extends PolarLineSeriesBaseView {
    static $t: Type;
    protected c9: PolarSplineSeries;
    constructor(a: PolarSplineSeries);
    au(): void;
    dd: Path;
    dc: Path;
    da(): void;
    db(a: List$1<Point>, b: number): void;
    protected bd(): void;
    protected be(): void;
