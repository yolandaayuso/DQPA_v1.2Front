 ...
 * @hidden
 */
export let ValueLayerFrame = /*@__PURE__*/ (() => {
    class ValueLayerFrame extends AxisAnnotationFrame {
        constructor() {
            super();
            this.af = null;
            this.ag = null;
    ...
    ValueLayerFrame.$t = /*@__PURE__*/ markType(ValueLayerFrame, 'ValueLayerFrame', AxisAnnotationFrame.$);
