...
var SeriesVisualDataManager = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    SeriesVisualDataManager.prototype.addSubSeriesLayerVisualData = function (a, b) {
        var c = a;
        var d = b;
        c.layers.add(d);
    };
    ...
    SeriesVisualDataManager.prototype.exportMarkerVisualData = function (a, b) {
        ...
        var c = b;
        a.w6.cj(function (d) {
            var e = _this.getMarkerVisualData(a, d, a.x1);
    ...
    SeriesVisualDataManager.prototype.exportLayerVisualData = function (a, b) {
        for (var c = 0; c < a.actualLayers.count; c++) {
