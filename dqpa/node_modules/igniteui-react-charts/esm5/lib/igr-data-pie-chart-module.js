...
var IgrDataPieChartModule = /** @class */ /*@__PURE__*/ (function () {
    function IgrDataPieChartModule() {
    }
    IgrDataPieChartModule.register = function () {
    ...
    return IgrDataPieChartModule;
}());
export { IgrDataPieChartModule };
