...
var SliceClickEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(SliceClickEventArgsDescriptionMetadata, _super);
    ...
    SliceClickEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.k(SliceClickEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.ac(SliceClickEventArgsDescriptionMetadata.a);
    };
    ...
    SliceClickEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.ae("SliceClickEventArgs", function () { return new SliceClickEventArgsDescription(); });
        a.ad("SliceClickEventArgs", SliceClickEventArgsDescriptionMetadata.a);
    };
