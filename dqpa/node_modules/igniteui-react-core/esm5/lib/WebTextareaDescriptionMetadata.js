 ...
 * @hidden
 */
var WebTextareaDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(WebTextareaDescriptionMetadata, _super);
    function WebTextareaDescriptionMetadata() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    WebTextareaDescriptionMetadata.b = function (a) {
    ...
    WebTextareaDescriptionMetadata.c = function (a) {
    ...
    WebTextareaDescriptionMetadata.d = function (a) {
        WebTextareaDescriptionMetadata.b(a);
        a.ae("WebTextarea", function () { return new WebTextareaDescription(); });
        a.ad("WebTextarea", WebTextareaDescriptionMetadata.a);
    };
    WebTextareaDescriptionMetadata.$t = markType(WebTextareaDescriptionMetadata, 'WebTextareaDescriptionMetadata');
    WebTextareaDescriptionMetadata.a = null;
    return WebTextareaDescriptionMetadata;
}(Base));
export { WebTextareaDescriptionMetadata };
