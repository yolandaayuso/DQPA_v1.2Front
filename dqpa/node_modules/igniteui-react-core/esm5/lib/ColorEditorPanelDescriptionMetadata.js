 ...
 * @hidden
 */
var ColorEditorPanelDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(ColorEditorPanelDescriptionMetadata, _super);
    function ColorEditorPanelDescriptionMetadata() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ColorEditorPanelDescriptionMetadata.b = function (a) {
    ...
    ColorEditorPanelDescriptionMetadata.c = function (a) {
        a.item("Value", "Brush");
    ...
    ColorEditorPanelDescriptionMetadata.d = function (a) {
        ColorEditorPanelDescriptionMetadata.b(a);
        a.ae("ColorEditorPanel", function () { return new ColorEditorPanelDescription(); });
        a.ad("ColorEditorPanel", ColorEditorPanelDescriptionMetadata.a);
    };
    ColorEditorPanelDescriptionMetadata.$t = markType(ColorEditorPanelDescriptionMetadata, 'ColorEditorPanelDescriptionMetadata');
    ColorEditorPanelDescriptionMetadata.a = null;
    return ColorEditorPanelDescriptionMetadata;
}(Base));
export { ColorEditorPanelDescriptionMetadata };
