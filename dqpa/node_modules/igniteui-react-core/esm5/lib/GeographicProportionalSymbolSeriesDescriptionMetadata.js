...
var GeographicProportionalSymbolSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(GeographicProportionalSymbolSeriesDescriptionMetadata, _super);
    ...
    GeographicProportionalSymbolSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.k(GeographicProportionalSymbolSeriesDescriptionMetadata.a)) {
            return;
        }
        a.ac(GeographicProportionalSymbolSeriesDescriptionMetadata.a);
    ...
    GeographicProportionalSymbolSeriesDescriptionMetadata.d = function (a) {
        ...
        a.ae("GeographicProportionalSymbolSeries", function () { return new GeographicProportionalSymbolSeriesDescription(); });
        a.ad("GeographicProportionalSymbolSeries", GeographicProportionalSymbolSeriesDescriptionMetadata.a);
    };
