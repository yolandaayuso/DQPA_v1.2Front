...
import { PopupMeasuringContentSizeEventArgsDescriptionMetadata } from "./PopupMeasuringContentSizeEventArgsDescriptionMetadata";
import { PopupDescription } from "./PopupDescription";
/**
 * @hidden
 */
var PopupDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(PopupDescriptionMetadata, _super);
    ...
    PopupDescriptionMetadata.b = function (a) {
        ...
        if (a.k(PopupDescriptionMetadata.a)) {
            return;
        }
        a.ac(PopupDescriptionMetadata.a);
        OnClosedEventArgsDescriptionMetadata.d(a);
        OnPopupEventArgsDescriptionMetadata.d(a);
        FocusEventArgsDescriptionMetadata.d(a);
        PopupMeasuringContentSizeEventArgsDescriptionMetadata.d(a);
    };
    PopupDescriptionMetadata.c = function (a) {
        a.item("IsFocusable", "Boolean");
        a.item("AnimationDuration", "Number:int");
        a.item("AnimationEnabled", "Boolean");
        a.item("AnimationType", "ExportedType:string:PopupAnimationType");
        a.item("AnimationType@names", "GrowShrink;FadeInOutSlide");
        ...
        a.item("DisableHitTestDuringAnimation", "Boolean");
        a.item("IsPointerEnabled", "Boolean");
        a.item("PointerPosition", "ExportedType:string:PopupPointerPosition");
        a.item("PointerPosition@names", "Auto;Top;Bottom;Left;Right");
        a.item("PointerBackground", "Brush");
        a.item("PointerSize", "Number:double");
        a.item("IsShowing", "Boolean");
        a.item("IsClosing", "Boolean");
        a.item("IsFixed", "Boolean");
        a.item("UseTopLayer", "Boolean");
        a.item("OnClosedRef", "EventRef::onClosed");
        a.item("OnPopupRef", "EventRef::onPopup");
        a.item("PopupGotFocusRef", "EventRef::popupGotFocus");
        a.item("PopupLostFocusRef", "EventRef::popupLostFocus");
        a.item("MeasuringContentSizeRef", "EventRef::measuringContentSize");
    };
    PopupDescriptionMetadata.d = function (a) {
        PopupDescriptionMetadata.b(a);
        a.ae("Popup", function () { return new PopupDescription(); });
        a.ad("Popup", PopupDescriptionMetadata.a);
    };
