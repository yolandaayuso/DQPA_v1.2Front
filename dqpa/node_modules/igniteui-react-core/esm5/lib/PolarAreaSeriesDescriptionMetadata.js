...
var PolarAreaSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(PolarAreaSeriesDescriptionMetadata, _super);
    ...
    PolarAreaSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.k(PolarAreaSeriesDescriptionMetadata.a)) {
            return;
        }
        a.ac(PolarAreaSeriesDescriptionMetadata.a);
    };
    ...
    PolarAreaSeriesDescriptionMetadata.d = function (a) {
        ...
        a.ae("PolarAreaSeries", function () { return new PolarAreaSeriesDescription(); });
        a.ad("PolarAreaSeries", PolarAreaSeriesDescriptionMetadata.a);
    };
