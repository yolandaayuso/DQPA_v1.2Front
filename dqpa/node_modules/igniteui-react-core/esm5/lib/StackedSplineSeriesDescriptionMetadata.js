...
var StackedSplineSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(StackedSplineSeriesDescriptionMetadata, _super);
    ...
    StackedSplineSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.k(StackedSplineSeriesDescriptionMetadata.a)) {
            return;
        }
        a.ac(StackedSplineSeriesDescriptionMetadata.a);
    };
    ...
    StackedSplineSeriesDescriptionMetadata.d = function (a) {
        ...
        a.ae("StackedSplineSeries", function () { return new StackedSplineSeriesDescription(); });
        a.ad("StackedSplineSeries", StackedSplineSeriesDescriptionMetadata.a);
    };
