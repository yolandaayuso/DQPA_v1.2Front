...
var ImageColumnDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(ImageColumnDescriptionMetadata, _super);
    ...
    ImageColumnDescriptionMetadata.b = function (a) {
        ...
        if (a.k(ImageColumnDescriptionMetadata.a)) {
            return;
        }
        a.ac(ImageColumnDescriptionMetadata.a);
    };
    ...
    ImageColumnDescriptionMetadata.d = function (a) {
        ...
        a.ae("ImageColumn", function () { return new ImageColumnDescription(); });
        a.ad("ImageColumn", ImageColumnDescriptionMetadata.a);
    };
