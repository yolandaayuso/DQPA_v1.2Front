...
export let DatePickerDescriptionMetadata = /*@__PURE__*/ (() => {
    class DatePickerDescriptionMetadata extends Base {
        static b(a) {
            ...
            if (a.k(DatePickerDescriptionMetadata.a)) {
                return;
            }
            a.ac(DatePickerDescriptionMetadata.a);
        ...
        static c(a) {
            a.item("__qualifiedNameTS", "String:XDatePicker");
            a.item("Value", "Date");
            a.item("Today", "Date");
            a.item("Label", "String");
        ...
        static d(a) {
            ...
            a.ae("DatePicker", () => new DatePickerDescription());
            a.ad("DatePicker", DatePickerDescriptionMetadata.a);
        }
    }
