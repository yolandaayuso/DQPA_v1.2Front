 ...
 * @hidden
 */
export let SVGParser = /*@__PURE__*/ (() => {
    class SVGParser extends Base {
        static c(a) {
            let b = false;
            let c = "";
            let d = "";
        ...
        static j(a) {
            let b = a.split(')');
            let c = new TransformGroup();
            for (let d = 0; d < b.length; d++) {
                let e = trimStart(b[d]);
                if (stringStartsWith(e, "rotate")) {
                    let f;
                    if (stringContains(e, ",")) {
                        f = stringReplace(e, "rotate(", "").split(',');
                    }
                    else {
                        f = stringReplace(e, "rotate(", "").split(' ');
                    }
                    ...
                    let h;
                    if (stringContains(e, ",")) {
                        h = stringReplace(e, "translate(", "").split(',');
                    }
                    else {
                        h = stringReplace(e, "translate(", "").split(' ');
                    }
                    let i = ((() => {
                        ...
                        $ret.j = parseFloat(h[0]);
                        $ret.k = parseFloat(h[1]);
                        return $ret;
                    })());
                    c.j.insert(0, i);
                }
    ...
    SVGParser.$t = /*@__PURE__*/ markType(SVGParser, 'SVGParser');
    return SVGParser;
})();
