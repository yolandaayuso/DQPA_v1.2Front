 ...
 * @hidden
 */
export let DataGridColumnDescriptionMetadata = /*@__PURE__*/ (() => {
    class DataGridColumnDescriptionMetadata extends Base {
        static b(a) {
            ...
            if (a.k(DataGridColumnDescriptionMetadata.a)) {
                return;
            }
            a.ac(DataGridColumnDescriptionMetadata.a);
        ...
        static d(a) {
            ...
            a.ad("DataGridColumn", DataGridColumnDescriptionMetadata.a);
        }
    }
    DataGridColumnDescriptionMetadata.$t = /*@__PURE__*/ markType(DataGridColumnDescriptionMetadata, 'DataGridColumnDescriptionMetadata');
