 ...
 * @hidden
 */
export let WebDatePickerDescriptionMetadata = /*@__PURE__*/ (() => {
    class WebDatePickerDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.ae("WebDatePicker", () => new WebDatePickerDescription());
            a.ad("WebDatePicker", WebDatePickerDescriptionMetadata.a);
        }
    }
    WebDatePickerDescriptionMetadata.$t = /*@__PURE__*/ markType(WebDatePickerDescriptionMetadata, 'WebDatePickerDescriptionMetadata');
