 ...
 * @hidden
 */
export let CssVisibilityPropertyAccessor = /*@__PURE__*/ (() => {
    class CssVisibilityPropertyAccessor extends UIElementPropertyAccessor {
        b(a) {
            let b = a;
    ...
    CssVisibilityPropertyAccessor.$t = /*@__PURE__*/ markType(CssVisibilityPropertyAccessor, 'CssVisibilityPropertyAccessor', UIElementPropertyAccessor.$);
