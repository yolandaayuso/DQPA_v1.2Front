 ...
 * @hidden
 */
export let RadialBaseChartDescriptionMetadata = /*@__PURE__*/ (() => {
    class RadialBaseChartDescriptionMetadata extends Base {
        static b(a) {
    ...
    RadialBaseChartDescriptionMetadata.$t = /*@__PURE__*/ markType(RadialBaseChartDescriptionMetadata, 'RadialBaseChartDescriptionMetadata');
