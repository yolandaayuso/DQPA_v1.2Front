 ...
 * @hidden
 */
export let CheckboxListIndexTypeChangedEventArgsDescriptionMetadata = /*@__PURE__*/ (() => {
    class CheckboxListIndexTypeChangedEventArgsDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.ae("CheckboxListIndexTypeChangedEventArgs", () => new CheckboxListIndexTypeChangedEventArgsDescription());
            a.ad("CheckboxListIndexTypeChangedEventArgs", CheckboxListIndexTypeChangedEventArgsDescriptionMetadata.a);
        }
    }
    CheckboxListIndexTypeChangedEventArgsDescriptionMetadata.$t = /*@__PURE__*/ markType(CheckboxListIndexTypeChangedEventArgsDescriptionMetadata, 'CheckboxListIndexTypeChangedEventArgsDescriptionMetadata');
