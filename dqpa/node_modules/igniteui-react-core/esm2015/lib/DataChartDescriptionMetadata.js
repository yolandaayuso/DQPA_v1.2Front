...
export let DataChartDescriptionMetadata = /*@__PURE__*/ (() => {
    class DataChartDescriptionMetadata extends Base {
        static b(a) {
            ...
            if (a.k(DataChartDescriptionMetadata.a)) {
                return;
            }
            a.ac(DataChartDescriptionMetadata.a);
        }
        static c(a) {
        ...
        static d(a) {
            ...
            a.ae("DataChart", () => new DataChartDescription());
            a.ad("DataChart", DataChartDescriptionMetadata.a);
        }
        static e(a) {
