 ...
 * @hidden
 */
export let WebPositionSettingsDescriptionMetadata = /*@__PURE__*/ (() => {
    class WebPositionSettingsDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.ae("WebPositionSettings", () => new WebPositionSettingsDescription());
            a.ad("WebPositionSettings", WebPositionSettingsDescriptionMetadata.a);
        }
    }
    WebPositionSettingsDescriptionMetadata.$t = /*@__PURE__*/ markType(WebPositionSettingsDescriptionMetadata, 'WebPositionSettingsDescriptionMetadata');
