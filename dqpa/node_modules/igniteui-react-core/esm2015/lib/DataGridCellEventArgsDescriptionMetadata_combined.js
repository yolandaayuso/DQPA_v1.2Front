 ...
 * @hidden
 */
export let DataGridCellEventArgsDescriptionMetadata = /*@__PURE__*/ (() => {
    class DataGridCellEventArgsDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.ae("DataGridCellEventArgs", () => new DataGridCellEventArgsDescription());
            a.ad("DataGridCellEventArgs", DataGridCellEventArgsDescriptionMetadata.a);
        }
    }
    DataGridCellEventArgsDescriptionMetadata.$t = /*@__PURE__*/ markType(DataGridCellEventArgsDescriptionMetadata, 'DataGridCellEventArgsDescriptionMetadata');
...
export let DataGridDescriptionMetadata = /*@__PURE__*/ (() => {
    class DataGridDescriptionMetadata extends Base {
        ...
        static d(a) {
            ...
            a.ae("DataGrid", () => new DataGridDescription());
