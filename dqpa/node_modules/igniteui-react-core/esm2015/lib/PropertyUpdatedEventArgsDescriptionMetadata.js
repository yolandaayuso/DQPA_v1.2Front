...
export let PropertyUpdatedEventArgsDescriptionMetadata = /*@__PURE__*/ (() => {
    class PropertyUpdatedEventArgsDescriptionMetadata extends Base {
        static b(a) {
            ...
            if (a.k(PropertyUpdatedEventArgsDescriptionMetadata.a)) {
                return;
            }
            a.ac(PropertyUpdatedEventArgsDescriptionMetadata.a);
        }
        static c(a) {
        ...
        static d(a) {
            ...
            a.ae("PropertyUpdatedEventArgs", () => new PropertyUpdatedEventArgsDescription());
            a.ad("PropertyUpdatedEventArgs", PropertyUpdatedEventArgsDescriptionMetadata.a);
        }
    }
