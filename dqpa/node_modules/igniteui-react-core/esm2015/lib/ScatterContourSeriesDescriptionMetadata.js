...
export let ScatterContourSeriesDescriptionMetadata = /*@__PURE__*/ (() => {
    class ScatterContourSeriesDescriptionMetadata extends Base {
        static b(a) {
            ...
            if (a.k(ScatterContourSeriesDescriptionMetadata.a)) {
                return;
            }
            a.ac(ScatterContourSeriesDescriptionMetadata.a);
        ...
        static d(a) {
            ...
            a.ae("ScatterContourSeries", () => new ScatterContourSeriesDescription());
            a.ad("ScatterContourSeries", ScatterContourSeriesDescriptionMetadata.a);
        }
    }
