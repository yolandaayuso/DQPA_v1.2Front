 ...
 * @hidden
 */
export let WebGridStateInfoDetailDescription = /*@__PURE__*/ (() => {
    class WebGridStateInfoDetailDescription extends Description {
        get_type() {
    ...
    WebGridStateInfoDetailDescription.$t = /*@__PURE__*/ markType(WebGridStateInfoDetailDescription, 'WebGridStateInfoDetailDescription', Description.$);
