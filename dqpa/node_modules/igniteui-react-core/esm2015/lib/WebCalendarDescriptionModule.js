 ...
 * @hidden
 */
export let WebCalendarDescriptionModule = /*@__PURE__*/ (() => {
    class WebCalendarDescriptionModule extends Base {
        static register(a) {
    ...
    WebCalendarDescriptionModule.$t = /*@__PURE__*/ markType(WebCalendarDescriptionModule, 'WebCalendarDescriptionModule');
