...
export var InteractionState = /*@__PURE__*/ (function (InteractionState) {
     ...
     */
    InteractionState[InteractionState["DragSelect"] = 3] = "DragSelect";
    /**
     * User gesture will start a pan action in a touch environment and a drag rectangle in a mouse environment.
     */
    InteractionState[InteractionState["Auto"] = 4] = "Auto";
    return InteractionState;
})({});
/**
 * @hidden
 */
export let InteractionState_$type = /*@__PURE__*/ markEnum('InteractionState', 'None,0|DragZoom,1|DragPan,2|DragSelect,3|Auto,4');
