...
export let VirtualDataSourceDescriptionMetadata = /*@__PURE__*/ (() => {
    class VirtualDataSourceDescriptionMetadata extends Base {
        static b(a) {
            ...
            if (a.k(VirtualDataSourceDescriptionMetadata.a)) {
                return;
            }
            a.ac(VirtualDataSourceDescriptionMetadata.a);
        }
        static c(a) {
        ...
        static d(a) {
            ...
            a.ae("VirtualDataSource", () => new VirtualDataSourceDescription());
            a.ad("VirtualDataSource", VirtualDataSourceDescriptionMetadata.a);
        }
    }
