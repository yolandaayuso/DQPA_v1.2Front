...
export let RangeCategorySeriesDescriptionMetadata = /*@__PURE__*/ (() => {
    class RangeCategorySeriesDescriptionMetadata extends Base {
        static b(a) {
            ...
            if (a.k(RangeCategorySeriesDescriptionMetadata.a)) {
                return;
            }
            a.ac(RangeCategorySeriesDescriptionMetadata.a);
        }
        static c(a) {
        ...
        static d(a) {
            ...
            a.ad("RangeCategorySeries", RangeCategorySeriesDescriptionMetadata.a);
        }
    }
