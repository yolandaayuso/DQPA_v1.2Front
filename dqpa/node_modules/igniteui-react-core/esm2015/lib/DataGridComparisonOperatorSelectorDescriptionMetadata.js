 ...
 * @hidden
 */
export let DataGridComparisonOperatorSelectorDescriptionMetadata = /*@__PURE__*/ (() => {
    class DataGridComparisonOperatorSelectorDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.ae("DataGridComparisonOperatorSelector", () => new DataGridComparisonOperatorSelectorDescription());
            a.ad("DataGridComparisonOperatorSelector", DataGridComparisonOperatorSelectorDescriptionMetadata.a);
        }
    }
    DataGridComparisonOperatorSelectorDescriptionMetadata.$t = /*@__PURE__*/ markType(DataGridComparisonOperatorSelectorDescriptionMetadata, 'DataGridComparisonOperatorSelectorDescriptionMetadata');
